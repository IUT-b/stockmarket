...
ax1 = fig.add_subplot(2,1,1)
ax1.plot(date1, df1['Close'],label=invest.head(1),color='red')
ax1.set_title('stock market')
ax1.set_ylabel(invest.head(1)+'(USD)')
ax1.legend()
ax1.grid()
ax1.tick_params(labelsize=7)

ax2 = ax1.twinx()
ax2.plot(date2, df2['Close'],label=invest.tail(1),color='blue')
ax2.set_ylabel(invest.tail(1)+'(USD)')
ax2.legend(loc='center left')
ax2.tick_params(labelsize=7)

ax3 = fig.add_subplot(2,1,2)
ax3.plot(date1, df1['Close'],label=invest.head(1),color='red')
ax3.set_xlabel('date')
ax3.set_ylabel(invest.head(1)+'(USD)')
ax3.legend()
ax3.grid()
ax3.tick_params(labelsize=7)

ax4 = ax3.twinx()
ax4.set_ylabel(invest.tail(1)+'(USD)')
ax4.plot(date2, df2['Close'],label=invest.tail(1),color='blue')
ax4.legend(loc='center left')
ax4.tick_params(labelsize=7)
